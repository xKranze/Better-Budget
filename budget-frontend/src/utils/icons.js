//export icon from https://fontawesome.com/icons/house?f=classic&s=thin&an=fade use in menuItems
export const dashboard = <i className="fa-thin fa-house fa-fade"></i>
